...
class _RegisterPage extends State<AddTokobunga> {
  ...
  TextEditingController harga_buket_bunga_segar_tokobunga = new TextEditingController();
  TextEditingController pemesanan_tokobunga = new TextEditingController();
  TextEditingController LatLng_tokobunga = new TextEditingController();
  ...
  Future<void> Simpan() async {
    ...
    String harga_buket_bunga_segar = harga_buket_bunga_segar_tokobunga.text;
    String pemesanan = pemesanan_tokobunga.text;
    String LatLng = LatLng_tokobunga.text;
    if (gerai.isEmpty || alamat.isEmpty || no_tlpn.isEmpty || jam_operasional.isEmpty
        || harga_buket_bunga_segar.isEmpty || pemesanan.isEmpty || LatLng.isEmpty) {
      ...
      final response = await http.post(Uri.parse(url), body: {
        ...
        "harga_buket_bunga_segar": harga_buket_bunga_segar,
        "pemesanan": pemesanan,
        "LatLng" : LatLng
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tambah Floristku'),
      ),
        ...
        child: Column(
          children: <Widget>[
            ...
            Padding(
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                    ...
                    hintText: 'Masukan No. Tlpn Toko Bunga'),
              ),
            ),
            const SizedBox(
              height: 10,
            ...
            Padding(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: TextField(
                controller: harga_buket_bunga_segar_tokobunga,
                autofocus: true,
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10.0))),
                    labelText: 'Harga Buket Bunga Segar',
                    hintText: 'Masukan Harga Buket Bunga Segar'),
              ),
            ),
            const SizedBox(
              height: 10,
            ...
            Padding(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 15),
              child: TextField(
                controller: pemesanan_tokobunga,
                autofocus: true,
                keyboardType: TextInputType.number,
                decoration: const InputDecoration(
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10.0))),
                    labelText: 'Pemesanan',
                    hintText: 'Masukan Pemesanan Buket Bunga Segar'),
              ),
            ),
            const SizedBox(
              height: 10,
              ...
              child: TextField(
                ...
                decoration: const InputDecoration(
                    border: OutlineInputBorder(
                        borderRadius: BorderRadius.all(Radius.circular(10.0))),
                    labelText: 'LatLng',
                    hintText: 'Masukan Latitude dan Longtitud Buket Bunga Segar'),
              ),
            ),
            const SizedBox(
              height: 10,
