...
class detail_tokobunga_view extends StatefulWidget {
  ...
  final String harga_buket_bunga_segar;
  ...
  const detail_tokobunga_view(
      {Key? key,
        ...
        required this.harga_buket_bunga_segar,
...
class _detail_tokobunga_viewState extends State<detail_tokobunga_view> {
  ...
  void setdata() async {
    ...
    harga_buket_bunga_segar_tokobunga.text = prefs.getString('harga_buket_bunga_segar').toString();
    pemesanan_tokobunga.text = prefs.getString('pemesanan').toString();
  }
